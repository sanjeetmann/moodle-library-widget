(function (window, undefined) {
	...
	function libraryBlock($) {
		...
		var moodleName = $('.breadcrumb-item:nth-child(3)').html();
		//the Moodle name is in the 3rd breadcrumb-item
		//the Moodle name was in the container-fluid class, formatted h1
		var courseID;
		if (moodleName.substring(0,2) == "FS") {
			courseID = "FS";
		} else if (moodleName.substring(0,3) == "Org") {
			courseID = "ORG";
		} else {
			courseID = moodleName.split(" (")[1].split("-")[0].trim();
		}
