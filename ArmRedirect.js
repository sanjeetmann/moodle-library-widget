(function (window, undefined) {
	...
	function libraryBlock($) {
		...
		var courseID = courseName.split("-")[0].trim(); //hyphens separate each word in the course name 
		function librarian(name,email,phone){ //constructor to create "librarian" objects
			this.name=name;
			this.email=email;
			this.phone=phone;
		}
		var Gabriela = new librarian("Gabriela Sonntag","gabriela_sonntag@redlands.edu","(909) 748-8096");
		...
		var destName; //variable to store name of research guide for testing purposes
		...
		var libraryBlock = $("#LibraryBlock"); //the library div has the id LibraryBlock
		libraryBlock.html("<p><a id='libraryLink' href='http://library.redlands.edu/guides' target='_blank'><img class='icon' alt='' src='http://www.ala.org/tools/sites/ala.org.tools/files/content/libfactsheets/librarysymbol.gif' height='16' width='16' />Research Guide</a></p><div id='librarianInfo' style='text-align:center;'></div><p style='text-align: center; font-size: x-small; font-style: italic;'>Chat with a librarian <br />(press F5 to update status)</p><div id='libchat_btn_widget' style='margin:0 auto; width: 125px;'></div>"); //inserts static HTML into the library block
		window.libchat_de84f389c957007460f8ce15a3891c6f = { //assigns parameters for the chat widget
				iid:635, 
				key:'9d5c89bc6648a41', 
				width:'240' 
		}
		var chatScriptURL = "http://redlands.libanswers.com/load_chat.php?hash=de84f389c957007460f8ce15a3891c6f&options=libchat_de84f389c957007460f8ce15a3891c6f";
